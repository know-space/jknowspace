...
public class Epoch {
     ...
     */
    public double getModifiedJulianValue()
    {
        return mjdValue;
    }
     ...
     */
    public double getJulianCenturiesPastJ2000()
    {
        return (getJulianValue()-TimeConstants.J2000_AS_JULIAN) * TimeConstants.DAYS_IN_CENTURY_INVERSE;
    }
     ...
     * @return
     */
    public static Epoch fromStringTDT(String NewDateTimeString)
    {
        return new Epoch(TimeUtilities.convertStringToMJD(NewDateTimeString));
    }
     ...
     */
    public static Epoch fromStringUTC(String NewDateTimeString)
    {
        double utcMJD = TimeUtilities.convertStringToMJD(NewDateTimeString);
    ...
    public double getGreenwichHourAngle()
    {
        ...
        double utc = getModifiedJulianValue() - TimeConstants.TDT_MINUS_UTC;
        double decDay = utc % 1;
